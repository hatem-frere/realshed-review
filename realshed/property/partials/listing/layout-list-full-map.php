<?php
/**
 * Property Grid — Full Map Layout
 * Card partial for the grid + full-width map page structure.
 *
 * Page structure: full-width map above | col-lg-4 sidebar | col-lg-8 content
 * Card type:      feature-block-one (vertical card — same as grid-sidebar)
 * Used by:        layout-grid-full-map Redux value
 *
 * The map is rendered by archive-property.php above the content area.
 * This file renders the individual property card inside the loop.
 * data-lat / data-lng attributes feed the map markers via map-helper.js.
 *
 * Path: wp-content/themes/realshed/property/partials/listing/layout-grid-full-map.php
 * @package Realshed
 */
