...
$args = array(
	...
	'save_defaults'   => true,
	'footer_credit'   => 'Created by Hatem Frere',
);
	...
	array(
		...
		'fields'     => array(
			...
			array(
				...
				'default' => 'Create Lasting Wealth Through Local Real Estate',
			),
			array(
				'id'      => 'banner_desc',
				'type'    => 'textarea',
				'title'   => esc_html__( 'Banner Description', 'realshed-core' ),
				'default' => 'Amet consectetur adipisicing elit sed do eiusmod.',
			),
		),
	)
);
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'     => esc_html__( 'Copy this shortcode and paste it where you want the form to appear:', 'realshed-core' ) .
					'<br><br><strong style="font-size:18px;color:#2ecc71;background:#f4f4f4;padding:5px 10px;border-radius:4px;border:1px solid #ddd;">[realshed_properties_search]</strong>',
				'style'    => 'info',
			),
			array(
